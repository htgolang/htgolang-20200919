...
func AddUsers() {
	...
	models.AddElement(&models.Users, *models.GenerateElement(models.GetMaxIDPlusOne(&models.Users), strings.TrimSpace(Name), strings.TrimSpace(Tel), strings.TrimSpace(Address), strings.TrimSpace(Birthday), strings.TrimSpace(PasswordPlainExt)))
	err = models.InsertToBoltDB(models.GenerateElement(models.GetMaxID(&models.Users), strings.TrimSpace(Name), strings.TrimSpace(Tel), strings.TrimSpace(Address), strings.TrimSpace(Birthday), strings.TrimSpace(PasswordPlainExt)))
	if err != nil {
