...
CREATE TABLE `alert_info`  (
  ...
  `fingerprint` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `instance` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `severity` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `alert_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  ...
  `labels` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `annotations` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
-- ----------------------------
INSERT INTO `alert_info` VALUES (4, '368e9616d542ab47', '192.168.199.25:9100', 'page', 'hostCpuUsageAlert', 'firing', '2020-02-29 19:45:22', '2020-02-29 19:49:22', '{\"alertname\":\"hostCpuUsageAlert\",\"instance\":\"192.168.199.25:9100\",\"severity\":\"page\"}', '{\"description\":\"192.168.199.25:9100 CPU 使用率超过 85% (当前值为: 0.9973333333333395)\",\"summary\":\"机器 192.168.199.25:9100 CPU 使用率过高\"}', '机器 192.168.199.25:9100 CPU 使用率过高', '192.168.199.25:9100 CPU 使用率超过 85% (当前值为: 0.9973333333333395)', '2021-01-28 00:31:34', '2021-01-28 00:31:34', NULL);
INSERT INTO `alert_info` VALUES (5, '368e9616d542ab48', '192.168.199.26:9100', 'page', 'hostCpuUsageAlert', 'firing', '2020-02-29 19:45:22', '2020-02-29 19:49:22', '{\"alertname\":\"hostCpuUsageAlert\",\"instance\":\"192.168.199.26:9100\",\"severity\":\"page\"}', '{\"description\":\"192.168.199.26:9100 CPU 使用率超过 85% (当前值为: 0.9973333333333395)\",\"summary\":\"机器 192.168.199.26:9100 CPU 使用率过高\"}', '机器 192.168.199.26:9100 CPU 使用率过高', '192.168.199.26:9100 CPU 使用率超过 85% (当前值为: 0.9973333333333395)', '2021-01-28 00:31:59', '2021-01-28 00:31:59', NULL);
INSERT INTO `alert_info` VALUES (6, '368e9616d542ab49', '192.168.199.27:9100', 'page', 'hostCpuUsageAlert', 'resolved', '2020-02-29 19:45:22', '2020-02-29 19:49:22', '{\"alertname\":\"hostCpuUsageAlert\",\"instance\":\"192.168.199.27:9100\",\"severity\":\"page\"}', '{\"description\":\"192.168.199.27:9100 CPU 使用率超过 85% (当前值为: 0.9973333333333395)\",\"summary\":\"机器 192.168.199.27:9100 CPU 使用率过高\"}', '机器 192.168.199.27:9100 CPU 使用率过高', '192.168.199.27:9100 CPU 使用率超过 85% (当前值为: 0.9973333333333395)', '2021-01-28 00:32:28', '2021-01-28 00:35:17', NULL);
...
INSERT INTO `permission` VALUES (11, '报警接口', '/alert/api');
INSERT INTO `permission` VALUES (12, '报警查询', '/alert/query');
...
INSERT INTO `role_permission` VALUES (20, 1, 11);
