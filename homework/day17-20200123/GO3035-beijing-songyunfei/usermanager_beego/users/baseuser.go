...
type AlertInfo struct {
	...
	EndsAt  time.Time 		`orm:"type(datetime)"`
...
func (u *Userinfo) InitDB(dbtype,dsn string) error {
	...
	orm.RegisterModel(&Userinfo{},&Permission{},&RoleInfo{},&UserRole{},&RolePermission{},&FileInfo{},&Recorder{},&AlertInfo{})
	...
	if count, err := qs.QueryTable(&Userinfo{}).Count(); err != nil {
		...
		if count == 0 {
			...
			fmt.Printf("Add user: %s,passwd:%s","admin","admin")
		}
		return nil
	}
}
